...
var Interface = /*#__PURE__*/function () {
  ...
  _createClass(Interface, [{
    ...
    value: function buildModal() {
      ...
      return (0, _redom.el)('div#cconsent-modal', (0, _redom.el)('div.ccm__content', (0, _redom.el)('div.ccm__content__heading', (0, _redom.el)('h2', _Language.default.getTranslation(window.CookieConsent.config, window.CookieConsent.config.language.current, 'modalMainTitle')), (0, _redom.el)('p', _Language.default.getTranslation(window.CookieConsent.config, window.CookieConsent.config.language.current, 'modalMainText')), window.CookieConsent.config.modalMainTextMoreLink && (0, _redom.el)('p', (0, _redom.el)('a', {
        href: window.CookieConsent.config.modalMainTextMoreLink,
        target: '_blank',
        rel: 'noopener noreferrer'
      }, _Language.default.getTranslation(window.CookieConsent.config, window.CookieConsent.config.language.current, 'learnMore'))), (0, _redom.el)('div.ccm__cheading__close', '×')), (0, _redom.el)('div.ccm__content__body', (0, _redom.el)('div.ccm__tabs', modalTabGroups())), (0, _redom.el)('div.ccm__footer', window.CookieConsent.config.showRejectAllButton && (0, _redom.el)('button.consent-decline', _Language.default.getTranslation(window.CookieConsent.config, window.CookieConsent.config.language.current, 'modalBtnRejectAll')), (0, _redom.el)('button.consent-submit', _Language.default.getTranslation(window.CookieConsent.config, window.CookieConsent.config.language.current, 'modalBtnSave')), (0, _redom.el)('button.consent-given', _Language.default.getTranslation(window.CookieConsent.config, window.CookieConsent.config.language.current, 'modalBtnAcceptAll')))));
    }
  }, {
    ...
    value: function addEventListeners(elements) {
      ...
      var buttonConsentGive = document.querySelectorAll('.consent-given');
      ...
      var _iterator4 = _createForOfIteratorHelper(buttonConsentDecline),
          _step4;
      ...
      this.elements['modal'].querySelector('.consent-submit').addEventListener('click', function () {
    ...
    value: function writeBufferToDOM() {
      var _iterator5 = _createForOfIteratorHelper(window.CookieConsent.buffer.appendChild),
          _step5;
      ...
      var _iterator6 = _createForOfIteratorHelper(window.CookieConsent.buffer.insertBefore),
          _step6;
...
var RemoveCookies = /*#__PURE__*/function () {
  ...
  _createClass(RemoveCookies, [{
            ...
            for (var i in config.services[service].cookies) {
              ...
              if (type === 'String') {
                ...
                for (var c in cookieList) {
                  if (_Utilities.default.objectType(cookieList[c]) !== 'String') {
                    continue;
                  }
    ...
    value: function removeCookie(cookie) {
      ...
      document.cookie = "".concat(cookie.name, "=; expires=Thu, 01 Jan 1970 00:00:00 UTC; ").concat(domain, " path=/;");
    }
  }]);
